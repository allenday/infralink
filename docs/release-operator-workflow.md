...
Woodpecker publication boundary as of Infralink `0.6.0`. It is not a runbook for
...
The typed `ReleaseCandidateV1` model in `src/infralink/release/contracts.py` is
the normative semantic validator used by the CLI and registry CI; it additionally
