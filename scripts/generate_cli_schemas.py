...
MODELS: dict[str, Any] = {
    ...
    "fleet-validate": Envelope[FleetValidationResult],
    ...
    "diagram-project": Envelope[DiagramProjectResult],
    ...
    "registry-host-get": Envelope[RegistryHostGetResult],
    "registry-host-patch": Envelope[RegistryHostPatchResult],
